...
class TaxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tax" do
    assert_difference('Tax.count') do
      post taxes_url, params: { tax: { description: @tax.description, name: @tax.name, rate: @tax.rate, status: @tax.status, user_id: @tax.user_id } }
    end
  ...
  test "should update tax" do
    patch tax_url(@tax), params: { tax: { description: @tax.description, name: @tax.name, rate: @tax.rate, status: @tax.status, user_id: @tax.user_id } }
