...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post currencies_url, params: { currency: { iso_code: @currency.iso_code, name: @currency.name, status: @currency.status, symbol: @currency.symbol, user_id: @currency.user_id } }
    end
  ...
  test "should update currency" do
    patch currency_url(@currency), params: { currency: { iso_code: @currency.iso_code, name: @currency.name, status: @currency.status, symbol: @currency.symbol, user_id: @currency.user_id } }
