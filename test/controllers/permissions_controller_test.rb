...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post permissions_url, params: { permission: { name: @permission.name, status: @permission.status } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { name: @permission.name, status: @permission.status } }
